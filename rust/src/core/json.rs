...
//! implementation's zero runtime dependencies.
//!
//! The emitter must byte-match `JSON.stringify(value, null, 2)`: 2-space
...
//! accepts what `JSON.parse` accepts for the shapes this CLI reads.
